...
def profil():
    ...
    return render_template('settings/profil.html', user=user)
...
def confidentialite():
    ...
    return render_template('settings/confidentialite.html', params=params)
...
def supprimer_compte():
    ...
    return render_template('settings/supprimer-compte.html')